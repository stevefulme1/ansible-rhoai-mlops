...
"""Unit tests for data_sovereignty_report_info module."""
...
from ansible_collections.stevefulme1.rhoai_mlops.plugins.modules.data_sovereignty_report_info import (
    get_module_args,
)


class TestDataSovereigntyReportInfoArgs:
    """Tests for data_sovereignty_report_info argument spec."""
