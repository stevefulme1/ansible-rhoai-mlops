...
"""Unit tests for data_residency_policy_info module."""
...
from ansible_collections.stevefulme1.rhoai_mlops.plugins.modules.data_residency_policy_info import (
    get_module_args,
)


class TestDataResidencyPolicyInfoArgs:
    """Tests for data_residency_policy_info argument spec."""
