...
"""Unit tests for compliance_evidence_info module."""
...
from ansible_collections.stevefulme1.rhoai_mlops.plugins.modules.compliance_evidence_info import (
    get_module_args,
)


class TestComplianceEvidenceInfoArgs:
    """Tests for compliance_evidence_info argument spec."""
